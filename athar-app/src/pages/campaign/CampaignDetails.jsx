...
import { getMediaOfCampaign, createContent, deletecontent, updatecontent } from "../../Repository/contentRepository";
              ...
              <div className="card-body p-5 p-md-7 text-center">
                  ...
                  <>
                    <div className="row">
                      {content.map((cnt) => {
                        ...
                        return (
                          <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb" key={cnt.id}>
                            <ContentCard
                              cnt={cnt}
                              arabicDate={arabicDate}
                              showCampaignInfo={false}
                              user={user}
                              onEdit={handleEditContent}   // ⭐ مهم
                            />
                          </div>
                        );
                      })}
                    ...
                    <Pagination page={currentPage} totalPages={totalPage} onPageChange={setCurrentPage} />
                  </>
                )}
                ...
                {user && user.role === "CharityAdmin" && (
                  <button
                    ...
                    style={{ padding: "10px 20px", backgroundColor: "#4eb6e6", color: "#fff", border: "none", borderRadius: "5px" }}
                  >
                    +إضافة ميديا
                  </button>
                )}
