...
const Index = () => {
    return (
        <div class="tailwind-scope">
            <div
                className="min-h-screen bg-gradient-to-br from-sky-50 to-white"
                dir="rtl"
            >
                <main className="p-6 lg:p-10">
                    <div className="mb-10">
                        <h1 className="text-gray-600 mt-2">
                            إليك نظرة عامة على إحصائيات الجمعية
                        </h1>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            {bottomStats.map((stat, i) => (
                                <div
                                    key={i}
                                    className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition border border-gray-100 hover:border-sky-300"
                                >
                                    <div className="flex items-center justify-between mb-4">
