...
// بيانات الجمعيات
const charitiesData = [
  { id: 1, name: "جمعية الخير", description: "مساعدة الفقراء", campaignsCount: 12, img: "https://via.placeholder.com/350" },
  { id: 2, name: "جمعية نور", description: "رعاية الأطفال", campaignsCount: 7, img: "https://via.placeholder.com/350" },
  { id: 3, name: "جمعية أمل", description: "دعم الأسر المحتاجة", campaignsCount: 4, img: "https://via.placeholder.com/350" },
];
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 lg:p-10" dir="rtl">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {charities.map((c) => (
          <div key={c.id} className="bg-white rounded-2xl p-5 shadow border relative">
