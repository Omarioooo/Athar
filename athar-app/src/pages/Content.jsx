...
export default function Content() {
    ...
    //                                                 <h4 className="card-title cnt-title">
    //                                                     {cnt.title}
    //                                                 </h4>
    //                                                 <p className="card-text content-description">
    //                                                     {cnt.description}
    //                                                 </p>
    //                                             </div>
    //                                             <hr />
    ...
    //                                                 <span>
    //                                                     <i className="fa-sharp fa-regular fa-heart ireaction"></i>{" "}
    //                                                     تفاعل1
    //                                                 </span>
    //                                                 <span>{cnt.arabicDate}</span>
    //                                             </div>
    //                                         </div>
    //                                     </div>
    //                                 </div>
                    ...
                    <>
                        <div className="row">
                            {contents.map((cnt) => {
                                ...
                                const arabicDate = date.toLocaleDateString(
                                    "ar-EG",
                                    {
                                        weekday: "long",
                                        year: "numeric",
...
>>>>>>> 45719df7ba826a6fe0047ee5b9f0cc4e7044b1eb
                        </div>
