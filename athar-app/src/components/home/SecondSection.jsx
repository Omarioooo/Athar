      ...
      >
        <div className="row">
          ...
          <div className="col-lg-4 col-sm-12 second-section-images">
            <img className="second-section-img rounded mx-auto d-block collage-img" src={descriptonImg} alt="description" />
            <img className="second-section-img2 rounded mx-auto d-block collage-img" src={descriptonImg2} alt="description" />
          </div>
        </div>
      </motion.div>
    );
