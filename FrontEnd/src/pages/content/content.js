...
import { getAllContents, searchMedia } from "../../service/ContentService";
...
export default function Content() {
  ...
  const loadContents = async (page) => {
    ...
    setErrorMessage("");
    try {
      const data = await getAllContents(page, pagesize);
  ...
  const handleSearch = async () => {
    ...
    setErrorMessage("");
    try {
      const data = await searchMedia(searchWord);
      setContents(data.contents);
                    ...
                    <div className="card content-card" style={{ width: "400px" }}>
                      <div className="img-campaign">
                        <div className="overlay-info">
                          ...
                          <p className="charity-name">{cnt.charityName}</p>
                        </div>
