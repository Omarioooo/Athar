import CharityRegister from "../charityregister/charityregister";
    ...
    return(
        ...
        <div className="container">
         <div className="row register-row">
          <div className=" col-lg-4 col-sm-12 register-card"
          onClick={()=>navigate("/charityregister")}    style={{ cursor: "pointer" }}>
            ...
            <p>للمؤسسات والجمعيات الخيريةالتى ترغب فى استقبال التبرعات وادارة المشاريع الخيرية</p>
            </div>
            <ul>
            ...
            <div className=" col-lg-4 col-sm-12 register-card2"
              onClick={()=>navigate("/donorregister")}    style={{ cursor: "pointer" }}>
            ...
            <p>للافراد الذين يرغبون فى دعم الجمعيات الخيريةوالمساهمة فى المشاريع الخيرية</p>
            </div>
            <ul>
