...
namespace AtharPlatform.Migrations
{
    ...
    [Migration("20251030212735_AddCharityExternalInfoAndCampaignImageUrl")]
    partial class AddCharityExternalInfoAndCampaignImageUrl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AtharPlatform.Models.Donation", b =>
                {
                    ...
                    b.Property<bool>("IsWebhookProcessed")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("AtharPlatform.Models.SubscribtionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AtharPlatform.Models.Donor", b =>
                {
                    ...
                    b.Property<string>("StripCustomerId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AtharPlatform.Models.Subscription", b =>
                {
                    b.HasOne("AtharPlatform.Models.SubscribtionType", "SubscribtionType")
                        .WithMany()
